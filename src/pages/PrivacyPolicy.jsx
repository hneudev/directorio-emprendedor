	...
	return (
		<div className='min-h-screen bg-white'>
			<div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20'>
				<h1 className='text-4xl sm:text-5xl font-bold text-gray-900 mb-8'>Política de Privacidad</h1>
				<p className='text-gray-600 mb-8 italic'>Última actualización: Febrero 2026</p>
				...
				<div className='prose prose-lg max-w-none'>
					...
					<section className='mb-8'>
						<h2 className='text-2xl font-bold text-gray-900 mb-4'>5. Anonimato</h2>
						<p className='text-gray-600 mb-4'>
					...
					<section className='mb-8'>
						<h2 className='text-2xl font-bold text-gray-900 mb-4'>6. Visibilidad Pública</h2>
						<p className='text-gray-600 mb-4'>
					...
					<section className='mb-8'>
						<h2 className='text-2xl font-bold text-gray-900 mb-4'>7. Requerimiento de WhatsApp</h2>
						<p className='text-gray-600 mb-4'>
					...
					<section className='mb-8'>
						<h2 className='text-2xl font-bold text-gray-900 mb-4'>8. Compartir Información</h2>
						<p className='text-gray-600 mb-4'>
					...
					<section className='mb-8'>
						<h2 className='text-2xl font-bold text-gray-900 mb-4'>10. Tus Derechos</h2>
